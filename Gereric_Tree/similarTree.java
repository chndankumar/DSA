...
public class similarTree {
    ...
    public static void main(String[] args) {
        ...
        boolean resShape = similarShape(root, root1);
    }
    ...
    private static boolean similarShape(Node root, Node root1) {
        if (root.children.size() != root1.children.size()) {
            return false;
        }
        for (int i = 0; i < root.children.size(); i++) {
            if (similarShape(root.children.get(i), root1.children.get(i)) != true) {
                return false;
            }
        }
        return true;
